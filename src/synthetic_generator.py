...
class Synthetic_data():
    ...
    def load_input_data(self, filename):
        path  = "DATA/input/tmp/" + filename 
        self.input_metadata = json.load(open(path + "/metadata.json"))
        self.input_metadata["id"] = filename
    ...
    def generate_synthetic_data(self):
        ...
        self.output_data = self.model.sample(num_rows=100)
    ...
    def generate_output_metadata(self, input_metadata):
        ...
        self.output_metadata["dataset name"] = "Synt:" + self.output_metadata["id"]
    ...
    def save_output_data(self):
        path = "DATA/output/tmp/" + self.output_metadata["dataset name"]
        os.mkdir(path)
